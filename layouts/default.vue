    ...
    <b-row>
      <b-col lg="2">
        <div class="mt-5 nav-bar">
          ...
          <b-nav vertical class="w-100 general-menu">
            <div style="height: 75vh">
              ...
              <b-nav-item><span class="ml-2">Perfil</span></b-nav-item>
            </div>
            <div>
              <b-nav-item>
                <svg
